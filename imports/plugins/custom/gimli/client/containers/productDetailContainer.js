...
class GimliProductDetailContainer extends Component {
  constructor(props) {
    super(props);
...
GimliProductDetailContainer.propTypes = {
...
export default composeWithTracker(composer, Loading)(GimliProductDetailContainer);
