...
const getPaystackSettings = () => {
  ...
  return {
    public: paystack.settings.publicKey || "pk_test_51d13dcb7888b9d21b2aa18c547f8cbab9de9139",
    secret: paystack.settings.secretKey || "sk_test_9e881b08f14654524b4a6f70d16af7cc42470d63"
  };
};
...
// Paystack payment
const fundWithPaystack = (email, amount) => {
  const paystackConfig = getPaystackSettings();
...
Template.wallet.events({
  ...
  "submit #deposit": event => {
    ...
    const mailRegex = /^[a-z0-9._% -]{2,63}@[a-z0-9.-]{2,23}\.[a-z]{2,5}$/i;
    ...
    fundWithPaystack(userMail, amount);
  },
